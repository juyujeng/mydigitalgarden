---
{"dg-publish":true,"permalink":"/Projects/DNR training robot/preparing meeting/","title":"研究討論會議","tags":["DNR","project","meeting"],"created":"2024-11-27T15:07","updated":"2024-12-10T13:44"}
---

- 預立醫療諮商需要團體諮商（至少需要2～3人）
- 要針對意願書或是同意書進行訓練（先以意願書為主）
    - 醫院志工對一般人說明預立DNR意願書
    - 問楊醫師、社工、主管單位是否志工可以進行預立意願書的說明
- 跟楊醫師確認徵聘資格以及啟示內容，確認後用謝老師名義張貼。
    - 確認可以張貼的地方
    - 助理資格：護理、（社工）
...
申請方式：請於YYYY/MM/DD前將履歷及相關文件寄至XXX@email.com，文件格式請註明「應徵研究助理_姓名」

---
{"dg-publish":true,"permalink":"/Blog/Research/同理的步驟20230312/","title":"同理的步驟","tags":["blog","empathy","empathy/course","manuscript"],"created":"2023-03-12","updated":"2023-03-14"}
---
...
同理心定義為一種多面向的認知能力，涉及能夠理解病人的同理需求（問題、情緒、想法，詳後說明）的能力，能夠與病人溝通並確認自己的理解，以及基於對於病人的理解，能夠溝通提升病人接受專業治療意願的能力。 

</div></div>


在與病人對話的過程當中如何有同理的與之溝通呢？我們提供一個理想步驟的大致流程，讓學員有所依規：首先治療師需覺察病人透露的同理線索，知道自己可能需要同理對方，若有未明之處，需向病人釐清線索。接著，治療師需透過溝通對話形成自己對於病人需求的理解，並與病人確認自己的理解是否正確。基於治療師形成的理解給予病人回應，並向其確認是否接受。簡單歸納為四個步驟：
...
這四個步驟不一定可以一次完成，可能需要在幾個步驟當中來回進行。如下圖所示，當治療師的理解有誤，或是回應不被病人接受時，治療師需要視情況重新釐清線索或是重新選擇回應的方式。各步驟的施行細節與具體的言行詳後述。
...
*實務上，其中部份的步驟（例如：釐清線索、理解與確認）可能會被跳過。可能是因為病人的訊息說地很清楚，或是醫療人員覺得自己的理解正確應不需要再確認。跳過這些步驟不一定最後無法完成回應使病人感到被同理。但若按照這個步驟來進行，可以避免錯誤理解的情況發生。*
...
治療師覺察到病人所表現出來的同理線索是去理解病人的同理需求並給予回應的第一步。這個步驟中治療師需對病人表達得不明確的線索、或是治療師覺得自己無法正確理解的線索進行釐清，以免做出錯誤的理解。
